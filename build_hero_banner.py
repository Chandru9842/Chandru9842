  ...
  <g id="rightSection">
    ...
    <g clip-path="url(#cpDock)">
      ...
      <a xlink:href="https://github.com/Chandru9842" href="https://github.com/Chandru9842" target="_blank" class="social-link">
        <g transform="translate(498, 468)">
          <rect width="122" height="42" rx="7" fill="{panel_inner_bg}" stroke="{panel_border}" stroke-width="1" class="social-card"/>
          <text x="61" y="20" text-anchor="middle" class="font-mono badge-lbl">GITHUB ↗</text>
          <text x="61" y="34" text-anchor="middle" class="font-mono t-val" font-size="10.5px">@Chandru9842</text>
        </g>
      </a>
      ...
      <a xlink:href="https://www.linkedin.com/in/chandru9842/" href="https://www.linkedin.com/in/chandru9842/" target="_blank" class="social-link">
        <g transform="translate(626, 468)">
          <rect width="122" height="42" rx="7" fill="{panel_inner_bg}" stroke="{panel_border}" stroke-width="1" class="social-card"/>
          <text x="61" y="20" text-anchor="middle" class="font-mono badge-lbl">LINKEDIN ↗</text>
          <text x="61" y="34" text-anchor="middle" class="font-mono t-val" font-size="10.5px">in/chandru9842</text>
        </g>
      </a>
      ...
      <a xlink:href="https://leetcode.com/u/Chandrum06/" href="https://leetcode.com/u/Chandrum06/" target="_blank" class="social-link">
        <g transform="translate(754, 468)">
          <rect width="122" height="42" rx="7" fill="{panel_inner_bg}" stroke="{panel_border}" stroke-width="1" class="social-card"/>
          <text x="61" y="20" text-anchor="middle" class="font-mono badge-lbl">LEETCODE ↗</text>
          <text x="61" y="34" text-anchor="middle" class="font-mono t-val" font-size="10.5px">@Chandrum06</text>
        </g>
      </a>

      <!-- Dock Item 4: GeeksforGeeks (Clickable Link) -->
      <a xlink:href="https://www.geeksforgeeks.org/profile/chandrum06" href="https://www.geeksforgeeks.org/profile/chandrum06" target="_blank" class="social-link">
        <g transform="translate(882, 468)">
          <rect width="122" height="42" rx="7" fill="{panel_inner_bg}" stroke="{panel_border}" stroke-width="1" class="social-card"/>
          <text x="61" y="20" text-anchor="middle" class="font-mono badge-lbl">GFG ↗</text>
          <text x="61" y="34" text-anchor="middle" class="font-mono t-val" font-size="10.5px">@chandrum06</text>
        </g>
      </a>

      <!-- Dock Item 5: Email (Clickable Mailto Link) -->
      <a xlink:href="mailto:chandrumohan550@gmail.com" href="mailto:chandrumohan550@gmail.com" target="_blank" class="social-link">
        <g transform="translate(1010, 468)">
          <rect width="128" height="42" rx="7" fill="{panel_inner_bg}" stroke="{panel_border}" stroke-width="1" class="social-card"/>
          <text x="64" y="20" text-anchor="middle" class="font-mono badge-lbl">EMAIL ✉</text>
          <text x="64" y="34" text-anchor="middle" class="font-mono t-val" font-size="10px">chandrumohan550</text>
        </g>
      </a>
    </g>
